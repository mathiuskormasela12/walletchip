            ...
            <div className="row">
              <form>
                <div className="my-5 position-relative d-flex align-items-center">
                  ...
                  <input type="password" className="form-control border-top-0 border-start-0 border-end-0 border-bottom-2 ps-5" id="email" aria-describedby="emailHelp" placeholder="Enter Your Email" />
                </div>
